...
public final class HandWrittenTfLiteModelLite {
  @NonNull
  private final Model model;

  private HandWrittenTfLiteModelLite(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    model = Model.createModel(context, "hand_written_tf_lite_model_lite.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static HandWrittenTfLiteModelLite newInstance(@NonNull Context context) throws
      IOException {
    return new HandWrittenTfLiteModelLite(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static HandWrittenTfLiteModelLite newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new HandWrittenTfLiteModelLite(context, options);
  }
