 ...
 */
public final class WrittingModel {
  @NonNull
  private final Model model;

  private WrittingModel(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "writting_model.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static WrittingModel newInstance(@NonNull Context context) throws IOException {
    return new WrittingModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static WrittingModel newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new WrittingModel(context, options);
  }
