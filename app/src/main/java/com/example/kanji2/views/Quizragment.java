...
import com.example.kanji2.Model.QuestionModel;
import com.example.kanji2.R;
import com.example.kanji2.viewmodel.QuestionViewModel;
...
public class Quizragment extends Fragment implements View.OnClickListener {
    ...
    private void resetOptions(){
        ...
        option4Btn.setBackground(ContextCompat.getDrawable(getContext() , R.drawable.button_bg));
    ...
    private void verifyAnswer(Button button){
        if (canAnswer){
              if (answer.equals(button.getText())){
                  button.setBackground(ContextCompat.getDrawable(getContext() , R.drawable.levelcorner));
                 correctAnswer++;
