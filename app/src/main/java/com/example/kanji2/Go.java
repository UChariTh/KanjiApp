...
public class Go extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MediaPlayer mediaPlayer1 = MediaPlayer.create(this,R.raw.go);
        MediaPlayer mediaPlayer2 = MediaPlayer.create(this,R.raw.gogatsu);
        MediaPlayer mediaPlayer3 = MediaPlayer.create(this,R.raw.gokan);
        MediaPlayer mediaPlayer4 = MediaPlayer.create(this,R.raw.gorin);
