...
public class AddDaysOfWeek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizDocRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Log.w("AddDaysOfWeekQuizzes", "Error getting document", e);
                quizCount.setText("Quiz " + quizNumber);
                ...
                quizzesRef.add(questionData)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(AddDaysOfWeek.this, "Error adding quiz question", Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.GONE);
                            }
                        });
            }
