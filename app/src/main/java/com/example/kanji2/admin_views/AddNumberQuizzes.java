...
public class AddNumberQuizzes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_number_quizzes);
                ...
                quizzesRef.add(questionData)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(AddNumberQuizzes.this, "Error adding quiz question", Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.GONE);
                            }
                        });
            }
