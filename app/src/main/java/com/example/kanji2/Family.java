...
public class Family extends AppCompatActivity {
    ...
    CardView cw1,cw2,cw3,cw4,cw5,cw6;
        ...
        View.OnClickListener cardClickListener=new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentlyHighlightedCard != null) {
                    ...
                    currentlyHighlightedCard.setBackgroundColor(ContextCompat.getColor(Family.this, android.R.color.white));
                    currentlyHighlightedCard.setBackground(ContextCompat.getDrawable(Family.this, R.drawable.levelcorner));
                }
                ...
                if (view instanceof CardView) {
                    ...
                    clickedCard.setBackground(ContextCompat.getDrawable(Family.this, R.drawable.select_card_view));
    ...
    private void navigateToLevel(String levelTag) {
        ...
        switch (level) {
            case "level1":
                intent = new Intent(getApplicationContext(), Chichi.class);
                intent.putExtra("selectedLevel",level);
                break;
            case "level2":
                intent = new Intent(getApplicationContext(), Ani.class);
                intent.putExtra("selectedLevel",level);
                break;
            case "level3":
                intent = new Intent(getApplicationContext(), Ane.class);
                intent.putExtra("selectedLevel",level);
                break;
            case "level4":
                intent = new Intent(getApplicationContext(), Haha.class);
                intent.putExtra("selectedLevel",level);
                break;
            case "level5":
                intent = new Intent(getApplicationContext(), Imotho.class);
                intent.putExtra("selectedLevel",level);
                break;
            case "level6":
                intent = new Intent(getApplicationContext(), Otouto.class);
                intent.putExtra("selectedLevel",level);
                break;
        ...
        if (intent != null && LockLevels.getSelectedNumber(level)<=(selectedLevel+1)) {
            ...
            Toast.makeText(Family.this, "Please select Unlocked Level !", Toast.LENGTH_SHORT).show();
        }
    }

    private void retrieveDataFromDatabase() {
        String userID= FirebaseAuth.getInstance().getCurrentUser().getUid();
        DocumentReference documentRef = FirebaseFirestore.getInstance().collection("Family").document(userID);
